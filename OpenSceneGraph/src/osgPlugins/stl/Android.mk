#ANDROID makefile         osgdb_stl

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/stl
...
LOCAL_MODULE :=           osgdb_stl

LOCAL_SRC_FILES :=         ReaderWriterSTL.cpp
