#ANDROID makefile         osgdb_tgz

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/tgz
...
LOCAL_MODULE :=           osgdb_tgz

LOCAL_SRC_FILES :=         ReaderWriterTGZ.cpp
