#ANDROID makefile         osgdb_pvr

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/pvr
...
LOCAL_MODULE :=           osgdb_pvr

LOCAL_SRC_FILES :=         ReaderWriterPVR.cpp
