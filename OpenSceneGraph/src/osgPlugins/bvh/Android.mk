#ANDROID makefile         osgdb_bvh

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/bvh
...
LOCAL_MODULE :=           osgdb_bvh

LOCAL_SRC_FILES :=         ReaderWriterBVH.cpp
