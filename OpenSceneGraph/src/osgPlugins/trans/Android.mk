#ANDROID makefile         osgdb_trans

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/trans
...
LOCAL_MODULE :=           osgdb_trans

LOCAL_SRC_FILES :=         ReaderWriterTRANS.cpp
