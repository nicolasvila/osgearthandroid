#ANDROID makefile         osgdb_scale

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/scale
...
LOCAL_MODULE :=           osgdb_scale

LOCAL_SRC_FILES :=         ReaderWriterSCALE.cpp
