#ANDROID makefile         osgdb_dw

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/dw
...
LOCAL_MODULE :=           osgdb_dw

LOCAL_SRC_FILES :=         ReaderWriterDW.cpp
