#ANDROID makefile         osgdb_pnm

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/pnm
...
LOCAL_MODULE :=           osgdb_pnm

LOCAL_SRC_FILES :=         ReaderWriterPNM.cpp
