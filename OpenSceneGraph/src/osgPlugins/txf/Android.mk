#ANDROID makefile         osgdb_txf

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/txf
...
LOCAL_MODULE :=           osgdb_txf

LOCAL_SRC_FILES :=         ReaderWriterTXF.cpp TXFFont.cpp
