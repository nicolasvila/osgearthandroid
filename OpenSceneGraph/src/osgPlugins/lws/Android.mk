#ANDROID makefile         osgdb_lws

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/lws
...
LOCAL_MODULE :=           osgdb_lws

LOCAL_SRC_FILES :=         ReaderWriterLWS.cpp SceneLoader.cpp
