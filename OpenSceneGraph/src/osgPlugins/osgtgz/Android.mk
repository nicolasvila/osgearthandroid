#ANDROID makefile         osgdb_osgtgz

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/osgtgz
...
LOCAL_MODULE :=           osgdb_osgtgz

LOCAL_SRC_FILES :=         ReaderWriterOSGTGZ.cpp
