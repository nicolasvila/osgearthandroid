#ANDROID makefile         osgdb_rgb

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/rgb
...
LOCAL_MODULE :=           osgdb_rgb

LOCAL_SRC_FILES :=         ReaderWriterRGB.cpp
