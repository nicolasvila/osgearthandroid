#ANDROID makefile         osgdb_glsl

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/glsl
...
LOCAL_MODULE :=           osgdb_glsl

LOCAL_SRC_FILES :=         ReaderWriterGLSL.cpp
