#ANDROID makefile         osgdb_gdal

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/gdal
...
LOCAL_MODULE :=           osgdb_gdal

LOCAL_SRC_FILES :=         ReaderWriterGDAL.cpp DataSetLayer.cpp
