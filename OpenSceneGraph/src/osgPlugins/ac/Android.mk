#ANDROID makefile         osgdb_ac

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/ac
...
LOCAL_MODULE :=           osgdb_ac

LOCAL_SRC_FILES :=         Exception.cpp Geode.cpp ac3d.cpp
