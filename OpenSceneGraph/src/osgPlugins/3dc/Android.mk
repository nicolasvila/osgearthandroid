#ANDROID makefile         osgdb_3dc

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/3dc
...
LOCAL_MODULE :=           osgdb_3dc

LOCAL_SRC_FILES :=         ReaderWriter3DC.cpp
