#ANDROID makefile         osgdb_osgviewer

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/OpenSceneGraph/src/osgPlugins/view
...
LOCAL_MODULE :=           osgdb_osgviewer

LOCAL_SRC_FILES :=         ReaderWriterOsgViewer.cpp
