#ANDROID makefile         osgdb_osgearth_gdal

LOCAL_PATH :=             /home/paulo/osgEarthAndroid/osgearth/src/osgEarthDrivers/gdal
...
LOCAL_MODULE :=           osgdb_osgearth_gdal

LOCAL_SRC_FILES :=         ReaderWriterGDAL.cpp
