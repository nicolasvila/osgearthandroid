...
LOCAL_SRC_FILES :=         AnnotationEditing.cpp AnnotationSettings.cpp AnnotationData.cpp AnnotationNode.cpp AnnotationRegistry.cpp AnnotationUtils.cpp CircleNode.cpp Decluttering.cpp Decoration.cpp EllipseNode.cpp FeatureNode.cpp LocalGeometryNode.cpp HighlightDecoration.cpp ImageOverlay.cpp ImageOverlayEditor.cpp LabelNode.cpp LocalizedNode.cpp RectangleNode.cpp ModelNode.cpp OrthoNode.cpp PlaceNode.cpp TrackNode.cpp AnnotationEditing.cpp FeatureEditing.cpp ImageOverlayEditor.cpp
